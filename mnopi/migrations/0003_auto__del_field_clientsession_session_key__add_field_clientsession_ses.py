...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ClientSession.session_key'
        db.delete_column('client_sessions', 'session_key')

        # Adding field 'ClientSession.session_token'
        db.add_column('client_sessions', 'session_token',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ClientSession.session_key'
        db.add_column('client_sessions', 'session_key',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=128),
                      keep_default=False)

        # Deleting field 'ClientSession.session_token'
        db.delete_column('client_sessions', 'session_token')
